  ...
  return {
    ...
    household: detail.household ? {
      ...
      children: detail.household.children.map((c) => ({
        ...
        extraMonthlyLivingCostNursing:    c.extraMonthlyLivingCostNursing    ?? c.extraMonthlyLivingCost ?? 2,
        extraMonthlyLivingCostElementary: c.extraMonthlyLivingCostElementary ?? c.extraMonthlyLivingCost ?? 2,
        extraMonthlyLivingCostMiddle:     c.extraMonthlyLivingCostMiddle     ?? c.extraMonthlyLivingCost ?? 2,
        extraMonthlyLivingCostHigh:       c.extraMonthlyLivingCostHigh       ?? c.extraMonthlyLivingCost ?? 2,
        extraMonthlyLivingCostUniversity: c.extraMonthlyLivingCostUniversity ?? c.extraMonthlyLivingCost ?? 2,
